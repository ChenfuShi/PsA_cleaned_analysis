...
# script to run the python script to extract counts from the hic files
...
-f $hic_loc/${FILES[$INDEX]}/${FILES[$INDEX]}.allValidPairs.hic \
-i $loops_file_CD4_8 \
-r 5000 \
-o $out_loc/${FILES[$INDEX]}_counts_CD8_CD4
...
-r 5000 \
-o $out_loc/${FILES[$INDEX]}_counts_CD8_CD8SF
